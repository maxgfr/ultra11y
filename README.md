...
ultra11y is built around an honest **division of labour**. Automated tools only catch a fraction of accessibility problems, so the engine does the *mechanical* work — 53 machine-detectable static checks tied to the WCAG 2.2 success criteria — and is explicit about everything it cannot decide:
