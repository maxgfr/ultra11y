...
/** One issue per RGAA criterion (stable de-dupe grain, regardless of --split). */
export function issueTitle(unit: PrdUnit): string {
...
export function pushIssues(units: PrdUnit[], lang: Lang): PushResult {
